...
abstract class BaseCheckedStandardFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_killer_question_id' => new sfWidgetFormDoctrineChoice(array('choices' => array('' => 'yes or no', 1 => 'yes', 0 => 'no'), 'model' => $this->getRelatedModelName('Standard'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'is_killer_question_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Standard'), 'column' => 'id')),
  ...
  public function getFields()
  {
    return array(
      ...
      'assigned_value'        => 'Text',
      'is_killer_question_id' => 'ForeignKey',
      'created_at'            => 'Date',
      'updated_at'            => 'Date',
    );
  }
