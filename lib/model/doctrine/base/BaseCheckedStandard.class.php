 ...
 * @property bool             $is_killer_question_id           Type: boolean
 ...
 * @method bool               getIsKillerQuestionId()          Type: boolean
 * @method CheckList          getCheckList()                   
 * @method Standard           getStandard()                    
 *  
 ...
 * @method CheckedStandard    setIsKillerQuestionId(bool $val) Type: boolean
 * @method CheckedStandard    setCheckList(CheckList $val)     
 * @method CheckedStandard    setStandard(Standard $val)       
 *  
 * @package    check-list
 * @subpackage model
...
abstract class BaseCheckedStandard extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('is_killer_question_id', 'boolean', null, array(
             'type' => 'boolean',
             'notnull' => true,
             ));
    }
    ...
    public function setUp()
    {
        ...
        $this->hasOne('Standard', array(
             'local' => 'is_killer_question_id',
             'foreign' => 'is_killer_question',
             'onDelete' => 'CASCADE'));
