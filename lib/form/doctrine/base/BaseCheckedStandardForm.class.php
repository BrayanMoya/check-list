...
<<<<<<< HEAD
      ...
      'is_killer_question_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Standard'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'is_killer_question_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Standard'), 'column' => 'is_killer_question')),
...
=======
    ...
    $this->setValidators(array(
      ...
      'option_selected'    => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'assigned_value'     => new sfValidatorPass(array('required' => false)),
      'is_killer_question' => new sfValidatorBoolean(),
      'created_at'         => new sfValidatorDateTime(),
      'updated_at'         => new sfValidatorDateTime(),
